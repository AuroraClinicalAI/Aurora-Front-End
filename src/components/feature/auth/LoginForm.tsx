...
export const LoginForm = () => {
  return (
    <div className="max-w-[473px] h-96 rounded-[5px] md:outline-2 md:outline-offset-[-2px] md:outline-zinc-800/20 flex flex-col items-center px-10 pt-8 gap-10 mx-auto">
      <div>
