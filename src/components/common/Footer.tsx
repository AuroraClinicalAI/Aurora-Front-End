export const Footer = () => {
  return (
    <footer className="footer min-h-25 relative bg-slate-500 flex justify-center md:justify-between px-10 py-3 gap-25 md:py-0 items-center flex-wrap md:flex-nowrap">
