        ...
        <div 
          ...
          >
              ...
              <ul className={`font-medium flex flex-col p-4 md:p-0 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 ${isMenuOpen ? `md:bg-white dark:bg-indigo-300 md:dark:bg-indigo-300` : ``} gap-5 `}>
                <li>
                  <a 
                    href="/login" 
                    className="rounded-lg p-2.5 text-white text-xl font-bold hover:bg-indigo-400"
                  >
                    Recursos
                  </a>
                </li>
          ...
          <div className='flex'>
            ...
            <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button type="button" className="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded={isUserMenuOpen} onClick={toggleUserMenu}>
                  <span className="sr-only">Open user menu</span>
                  <img className="w-8 h-8 rounded-full" src="/docs/images/people/profile-picture-3.jpg" alt="user photo" />
                </button>
                {isUserMenuOpen &&
                  <div className="z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600 absolute translate-y-40 translate-x-[-150px]">
